...
- (void)sliderValueChange:(YESlider *)slider {
...
- (UIView *)bottomBar {
    if (!_bottomBar) {
        ...
        [fullScreenBtn setImage:[UIImage imageNamed:@"playerImages.bundle/btn_zoom_out"] forState:UIControlStateNormal];
        [fullScreenBtn setImage:[UIImage imageNamed:@"playerImages.bundle/btn_zoom_in"] forState:UIControlStateSelected];
        ...
        YESlider *slider = [[YESlider alloc] init];
        slider.value = 0.0f;
        ...
        self.slider = slider;
        __weak typeof(self) weakSelf = self;
        slider.valueChangeBlock = ^(YESlider *slider){
            [weakSelf sliderValueChange:slider];
        };
        slider.finishChangeBlock = ^(YESlider *slider){
            [weakSelf finishChange];
        };
        slider.draggingSliderBlock = ^(YESlider *slider){
            [weakSelf dragSlider];
        };
...
- (UIButton *)playOrPauseBtn {
    if (!_playOrPauseBtn) {
        ...
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"playerImages.bundle/play"] forState:UIControlStateNormal];
        [_playOrPauseBtn setBackgroundImage:[UIImage imageNamed:@"playerImages.bundle/pause"] forState:UIControlStateSelected];
